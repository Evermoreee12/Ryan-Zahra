...
export const WEDDING_CONFIG: WeddingConfig = {
  ...
  events: {
    akad: {
      ...
      venue: {
        name: import.meta.env.PUBLIC_AKAD_VENUE_NAME ?? "The Royal Azure Ballroom",
        address: import.meta.env.PUBLIC_AKAD_VENUE_ADDRESS ?? "Jl. Elok No. 77",
        mapsEmbedUrl: import.meta.env.PUBLIC_AKAD_VENUE_MAPS ?? "https://maps.google.com/maps?q=-6.2088,106.8456&output=embed",
      },
    },
    resepsi: {
      ...
      venue: {
        name: import.meta.env.PUBLIC_RESEPSI_VENUE_NAME ?? "The Royal Azure Ballroom",
        address: import.meta.env.PUBLIC_RESEPSI_VENUE_ADDRESS ?? "Jl. Elok No. 77",
        mapsEmbedUrl: import.meta.env.PUBLIC_RESEPSI_VENUE_MAPS ?? "https://maps.google.com/maps?q=-6.2088,106.8456&output=embed",
      },
    },
  },
  hero: {
